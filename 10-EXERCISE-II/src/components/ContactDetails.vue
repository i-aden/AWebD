  ...
  <el-card class="box-card-main">
    ...
    <el-row>
      <el-col :span="24">
        <div class="grid-content bg-purple-light">
          <el-button style="padding: 0px 5px; font-size: 34px" type="plain">{{
            friend.name + " (" + friend.numMedals + " Medal)"
          }}</el-button>
        </div>
      </el-col>
    </el-row>
    ...
    <el-row>
      <div class="grid-content-show-detail bg-white">
        <el-button style="width: 100%" type="success" @click="toggleMedal"
          >Toggle Medal Status</el-button
        >
        <el-divider></el-divider>
        <el-button style="width: 100%" type="success" @click="toggleDetails"
          >{{ detailsAreVisible ? "Hide" : "Show" }} Details</el-button
        >
      </div>
    </el-row>
...
const emit = defineEmits(["toggle-medal"]);
...
function toggleMedal() {
  ...
  emit("toggle-medal", props.id, hasWonMedal);
}
</script>
